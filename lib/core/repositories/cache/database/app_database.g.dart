...
class $AuthTokensTable extends AuthTokens
    with TableInfo<$AuthTokensTable, AuthTokenEntity> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AuthTokenEntity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  AuthTokenEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class AuthTokenEntity extends DataClass implements Insertable<AuthTokenEntity> {
  final String key;
  final String value;
  const AuthTokenEntity({required this.key, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  AuthTokensCompanion toCompanion(bool nullToAbsent) {
    return AuthTokensCompanion(key: Value(key), value: Value(value));
  }

  factory AuthTokenEntity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  AuthTokenEntity copyWith({String? key, String? value}) =>
      AuthTokenEntity(key: key ?? this.key, value: value ?? this.value);
  AuthTokenEntity copyWithCompanion(AuthTokensCompanion data) {
    return AuthTokenEntity(
  ...
  @override
  String toString() {
    return (StringBuffer('AuthTokenEntity(')
          ..write('key: $key, ')
          ..write('value: $value')
          ..write(')'))
        .toString();
...
class AuthTokensCompanion extends UpdateCompanion<AuthTokenEntity> {
  ...
  AuthTokensCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       value = Value(value);
  static Insertable<AuthTokenEntity> custom({
...
class $UsersTable extends Users with TableInfo<$UsersTable, UserEntity> {
  ...
  UserEntity map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserEntity(
      ...
      data: $UsersTable.$converterdata.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}data'],
        )!,
...
class UserEntity extends DataClass implements Insertable<UserEntity> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['data'] = Variable<String>($UsersTable.$converterdata.toSql(data));
    }
    return map;
  }
  ...
  UserEntity copyWith({int? id, UserData? data}) =>
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserEntity && other.id == this.id && other.data == this.data);
}
...
class UsersCompanion extends UpdateCompanion<UserEntity> {
  ...
  UsersCompanion copyWith({Value<int>? id, Value<UserData>? data}) {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (data.present) {
      map['data'] = Variable<String>(
        $UsersTable.$converterdata.toSql(data.value),
      );
    }
    return map;
  }
...
class $$AuthTokensTableTableManager
    extends
        RootTableManager<
          ...
          (
            AuthTokenEntity,
            BaseReferences<_$AppDatabase, $AuthTokensTable, AuthTokenEntity>,
          ),
          AuthTokenEntity,
          PrefetchHooks Function()
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> rowid = const Value.absent(),
              }) => AuthTokensCompanion(key: key, value: value, rowid: rowid),
          createCompanionCallback:
              ({
                required String key,
                required String value,
...
typedef $$UsersTableCreateCompanionBuilder =
    UsersCompanion Function({Value<int> id, required UserData data});
typedef $$UsersTableUpdateCompanionBuilder =
    UsersCompanion Function({Value<int> id, Value<UserData> data});
