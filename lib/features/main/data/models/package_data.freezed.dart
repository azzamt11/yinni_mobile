...
@HiveField(0) DateTime get date;@HiveField(1) List<PackageItem> get items;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PackageData&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other.items, items));
}
...
@override
String toString() {
  return 'PackageData(date: $date, items: $items)';
}
...
@useResult
$Res call({
@HiveField(0) DateTime date,@HiveField(1) List<PackageItem> items
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  DateTime date, @HiveField(1)  List<PackageItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PackageData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  DateTime date, @HiveField(1)  List<PackageItem> items)  $default,) {final _that = this;
switch (_that) {
case _PackageData():
return $default(_that.date,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)  DateTime date, @HiveField(1)  List<PackageItem> items)?  $default,) {final _that = this;
switch (_that) {
case _PackageData() when $default != null:
return $default(_that.date,_that.items);case _:
  return null;
...
class _PackageData implements PackageData {
  const _PackageData({@HiveField(0) required this.date, @HiveField(1) required final  List<PackageItem> items}): _items = items;
...
@override@HiveField(1) List<PackageItem> get items {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PackageData&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other._items, _items));
}
